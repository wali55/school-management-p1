            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4">
              <div className="bg-white rounded-md p-4">
                ...
                <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                  <Link href="/" className="p-3 rounded-md bg-waliSkyLight">Teacher&apos;s Classes</Link>
                  <Link href="/" className="p-3 rounded-md bg-waliPurpleLight">Teacher&apos;s Students</Link>
                  <Link href="/" className="p-3 rounded-md bg-waliYellowLight">Teacher&apos;s Lessons</Link>
                  <Link href="/" className="p-3 rounded-md bg-pink-50">Teacher&apos;s Exams</Link>
                  <Link href="/" className="p-3 rounded-md bg-waliSkyLight">Teacher&apos;s Assignments</Link>
                </div>
              </div>
              <Performance />
              <Announcements />
